...
function CIVILIANS_MODULE.all_done()
  ...
  if PARAM.bool_civilians == 1 then
    if SCRIPTS.soundinfo then
        SCRIPTS.soundinfo = SCRIPTS.soundinfo .. CIVILIANS_MODULE.CIV_SNDINFO
    else
      SCRIPTS.soundinfo = CIVILIANS_MODULE.CIV_SNDINFO
    end

    if SCRIPTS.decorate_lines then
      SCRIPTS.decorate_lines = SCRIPTS.decorate_lines .. CIVILIANS_MODULE.CIV_DEC
    else
      SCRIPTS.decorate_lines = CIVILIANS_MODULE.CIV_DEC
    end
  ...
  if PARAM.bool_scientists == 1 then
    if SCRIPTS.decorate_lines then
      SCRIPTS.decorate_lines = SCRIPTS.decorate_lines .. CIVILIANS_MODULE.SCI_DEC
    else
      SCRIPTS.decorate_lines = CIVILIANS_MODULE.SCI_DEC
    end

    if SCRIPTS.soundinfo then
      SCRIPTS.soundinfo = SCRIPTS.soundinfo .. CIVILIANS_MODULE.SCI_SNDINFO
    else
      SCRIPTS.soundinfo = CIVILIANS_MODULE.SCI_SNDINFO
    end
