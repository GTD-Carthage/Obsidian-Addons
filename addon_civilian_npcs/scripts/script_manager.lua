...
function ScriptMan_assemble_decorate_lump()
  ...
  -- Craneo civilians
  if SCRIPTS.civilians_dec then
    decorate_script_lines = decorate_script_lines ..
    SCRIPTS.civilians_dec .. "\n"
  end
  
  if SCRIPTS.scientists_dec then
    decorate_script_lines = decorate_script_lines ..
    SCRIPTS.scientists_dec .. "\n"
  end
...
function ScriptMan_assemble_sndinfo_lump()
  ...
  -- Craneo civilians
  if SCRIPTS.civilians_SNDINFO then
    sndinfo_lines = sndinfo_lines ..
    SCRIPTS.civilians_SNDINFO .. "\n"
  end
  
  if SCRIPTS.scientists_SNDINFO then
    sndinfo_lines = sndinfo_lines ..
    SCRIPTS.scientists_SNDINFO .. "\n"
  end
